...
ShrubberyCreationForm::ShrubberyCreationForm( void ) : Form("SCF", 145, 137), sign(145), exec(137){
	std::cout << "ShrubberyCreationForm created by default!\n";
}

ShrubberyCreationForm::ShrubberyCreationForm( std::string s ) : Form("SCF", 145, 137), sign(145), exec(137){
	this->target = s;
...
ShrubberyCreationForm::ShrubberyCreationForm( ShrubberyCreationForm const &S ) : Form(S), sign(145), exec(137){
